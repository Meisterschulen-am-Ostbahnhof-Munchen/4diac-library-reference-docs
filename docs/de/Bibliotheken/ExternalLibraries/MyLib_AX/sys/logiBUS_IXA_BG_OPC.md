...
`logiBUS_IXA_BG_OPC` ist der wiederverwendbare Baustein für **einen einzelnen digitalen Eingang** mit VT-Statusanzeige (Hintergrundfarbe) und OPC-UA-Publish. Er wird 8-fach parametrisiert in [`InputOutputTesterButton_DIDO_OPC_UA`](https://docs.ms-muc-docs.de/projects/visual-programming-languages-docs/en/latest/Uebungen/test_AX/Meins/InputOutputTester/Button_DIDO_OPC_UA/InputOutputTesterButton_DIDO_OPC_UA/) instanziiert und unverändert auch im PWM-Beispiel [`InputOutputTesterButton_PWM_OPC_UA`](https://docs.ms-muc-docs.de/projects/visual-programming-languages-docs/en/latest/Uebungen/test_AX/Meins/InputOutputTester/Button_PWM_OPC_UA/InputOutputTesterButton_PWM_OPC_UA/) für dessen 8 Eingänge wiederverwendet.
