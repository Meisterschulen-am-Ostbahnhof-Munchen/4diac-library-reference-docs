...
- [F_SUB](../../../StandardLibraries/iec61131-3/arithmetic/F_SUB.md) — das normale,
  ...
  Melden).
- [Uebung_011b3](https://docs.ms-muc-docs.de/projects/visual-programming-languages-docs/de/latest/Uebungen/test_B/Uebungen_doc/Uebung_011b3/) — der Hardware-Befund,
  der diese Bibliothek motiviert hat.
- [Uebung_011b5](https://docs.ms-muc-docs.de/projects/visual-programming-languages-docs/de/latest/Uebungen/test_B/Uebungen_doc/Uebung_011b5/) — dasselbe
