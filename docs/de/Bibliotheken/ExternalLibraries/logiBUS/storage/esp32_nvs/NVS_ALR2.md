...
| `DEFAULT_VALUE` | LREAL | Standardwert, falls der Schlüssel im NVS nicht existiert (Voreinstellung: 0.0) |
...
| ------- | --- | --------- |
| `VAL` | `adapter::types::bidirectional::ALR2` (Socket) | Wert (LREAL) |
