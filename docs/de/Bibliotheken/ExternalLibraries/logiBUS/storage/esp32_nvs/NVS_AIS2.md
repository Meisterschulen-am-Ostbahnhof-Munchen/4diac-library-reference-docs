...
| `DEFAULT_VALUE` | STRING | Standardwert, falls der Schlüssel im NVS nicht existiert (Voreinstellung: '') |
...
| ------- | --- | --------- |
| `VAL` | `adapter::types::bidirectional::AIS2` (Socket) | Wert (STRING) |
