...
| `DEFAULT_VALUE` | UDINT | Standardwert, falls der Schlüssel im NVS nicht existiert (Voreinstellung: 0) |
...
| ------- | --- | --------- |
| `VAL` | `adapter::types::bidirectional::AUDI2` (Socket) | Wert (UDINT) |
