...
| `DEFAULT_VALUE` | SINT | Standardwert, falls der Schlüssel im NVS nicht existiert (Voreinstellung: 0) |
...
| ------- | --- | --------- |
| `VAL` | `adapter::types::bidirectional::AS2` (Socket) | Wert (SINT) |
