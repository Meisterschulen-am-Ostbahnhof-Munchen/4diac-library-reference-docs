...
| Name | Typ | Beschreibung |
| ---- | --- | ------------ |
| VAL | adapter::types::bidirectional::AS2 | Bidirektionaler Adapter für den Austausch von Werten. Über diesen Adapter wird der gelesene Wert als Ausgang (DO1) bereitgestellt und ein Schreibwert als Eingang (DI1) entgegengenommen. |
