...
- **AR_CLIENT_1_0_UNGATED**: Verzichtet auf das interne `E_D_FF_ANY`-Flipflop (Change-Filter) und löst bei jedem `IN.E1`-Ereignis bedingungslos den Remote-Write bzw. Methodenaufruf aus — ideal für wiederholte Taster-/VT-Eingaben desselben Werts.
