...
| `OPTIONS` | `USINT` | `6` | Options-Bitmaske: Bit 0 = Zeichensatz (0=ISO-8859-1, 1=UTF-16), Bit 1 = Transparenter Hintergrund, Bit 2 = Rahmen unterdrücken (beschreibbar via *Change Attribute* F.38). |
...
| `ENABLED` | `USINT` | `[9]` | **Nur-Lesen (Read-only)** für *Change Attribute* (ISO 11783-6). Options 2 Bitmaske: Bit 0 = Aktiviert, Bit 1 = Ausgewählt (Fokus). Abfragbar via *Get Attribute Value* (F.58); Steuerung via *Enable/Disable Object* (F.4) oder *Select Input Object* (F.6). |
