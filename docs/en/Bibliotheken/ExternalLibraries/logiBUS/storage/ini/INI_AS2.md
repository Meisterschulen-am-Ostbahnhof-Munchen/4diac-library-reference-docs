...
Thus, read and write access to the settings.ini file can be controlled via the AS2 adapter.

## Technical Features

- The block uses a bidirectional AS2 adapter that can both send and receive values.
- A SINT value is used as the default value.
