...
| Name | Type | Description |
| ---- | ---- | ----------- |
| VAL | adapter::types::bidirectional::ALR2 | Bidirectional adapter for exchanging values. This adapter provides the read value as an output (DO1) and receives a write value as an input (DI1). |
